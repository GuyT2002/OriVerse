...
const allTutorials: Tutorial[] = [
  ...
  { slug: 'simple-boat', title: 'Fold a Simple Paper Boat', date: '2024-05-05', excerpt: 'A fun and easy model that actually floats (for a while!).', imageUrl: '/images/defect.jpg', content: '...', category: 'Beginner Tutorials', skillLevel: 'Beginner', videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', dataAiHint: "origami paper boat tutorial"}, // Placeholder image (defect)
  ...
  { slug: 'jumping-frog', title: 'How to Fold a Jumping Frog', date: '2024-05-15', excerpt: 'Fold a frog that really jumps! Hours of fun included.', imageUrl: '/images/kingfisher.jpg', content: '...', category: 'Intermediate Tutorials', skillLevel: 'Intermediate', dataAiHint: "origami frog tutorial" }, // Placeholder image (kingfisher)
