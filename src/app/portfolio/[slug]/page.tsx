...
const allPieces: OrigamiPiece[] = [
    ...
    { id: 'crested-kingfisher', title: 'Crested Kingfisher', slug: 'crested-kingfisher', description: 'A delicate origami model of a Crested Kingfisher perched elegantly. The Washi paper adds texture and suits the bird\'s form.', imageUrl: '/images/kingfisher.jpg', category: 'Animals', dateCreated: '2024-04-01', difficulty: 'Intermediate', materials: 'Washi Paper (18cm x 18cm)', dataAiHint: "blue bird kingfisher" },
