...
const allPieces: OrigamiPiece[] = [
    ...
    { id: 'origami-archer', title: 'Origami Archer', slug: 'origami-archer', description: 'An original design of a hooded archer, poised with bow and arrow. The double tissue paper allows for fine details in the clothing and weapon.', imageUrl: 'https://picsum.photos/seed/greenarcher/800/800', category: 'Characters', dateCreated: '2024-06-25', difficulty: 'Advanced', materials: 'Double Tissue Paper (35cm x 35cm)', dataAiHint: "green archer fantasy origami" }, // Updated image seed and hint
