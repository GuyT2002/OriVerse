...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg border border-border bg-card text-card-foreground shadow-sm", // Use border variable
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3 // Use h3 for semantic card titles within sections
    ref={ref}
    className={cn(
...
>(({ className, ...props }, ref) => (
  <p // Use p for semantic descriptions
    ref={ref}
