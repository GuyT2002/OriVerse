...
export default {
    darkMode: ["class"], // Keep darkMode as class for potential future light mode toggle
    content: [
  ...
  theme: {
      ...
      // Configure typography styles, including dark mode overrides
      typography: (theme: (key: string) => string) => ({
        DEFAULT: {
          css: {
            ...
            // Dark mode overrides (now default)
