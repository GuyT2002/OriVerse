...
const allTutorials: Tutorial[] = [
  ...
  { slug: 'simple-boat', title: 'Fold a Simple Paper Boat', date: '2024-05-05', excerpt: 'A fun and easy model that actually floats (for a while!).', imageUrl: '/images/surfing_bird.jpg', content: '...', category: 'Beginner Tutorials', skillLevel: 'Beginner', videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', dataAiHint: "origami paper boat"}, // Updated image
  ...
  { slug: 'intermediate-box', title: 'Origami Box with Lid', date: '2024-05-10', excerpt: 'Create a useful and decorative box from two sheets of paper.', imageUrl: '/images/rooster.jpg', content: '...', category: 'Intermediate Tutorials', skillLevel: 'Intermediate', dataAiHint: "origami paper box" }, // Updated image
  { slug: 'jumping-frog', title: 'How to Fold a Jumping Frog', date: '2024-05-15', excerpt: 'Fold a frog that really jumps! Hours of fun included.', imageUrl: '/images/archer.jpg', content: '...', category: 'Intermediate Tutorials', skillLevel: 'Intermediate', dataAiHint: "origami paper frog" }, // Updated image
  { slug: 'advanced-rose', title: 'Folding the Kawasaki Rose', date: '2024-05-20', excerpt: 'Challenge yourself with this beautiful and intricate rose model.', imageUrl: '/images/the_defect.jpg', content: '...', category: 'Advanced Creations', skillLevel: 'Advanced', dataAiHint: "origami paper rose" }, // Updated image
  { slug: 'modular-star-detail', title: 'Advanced Modular Star Folding', date: '2024-05-25', excerpt: 'Combine multiple units to create a stunning geometric star.', imageUrl: '/images/kingfisher.jpg', content: '...', category: 'Advanced Creations', skillLevel: 'Advanced', dataAiHint: "origami modular star" }, // Updated image
];
